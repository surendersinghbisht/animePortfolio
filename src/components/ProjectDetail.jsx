...
const ProjectDetailsComp = ({ title, description, tools, image, githubLink, liveLink }) => {
  ...
  return (
    <div className="h-screen font-heading p-8 bg-black text-white overflow-y-auto">
      ...
      <button
        onClick={handleBack}
        className="mb-4 px-4 py-2 bg-customRed text-black rounded hover:bg-white transition-colors"
      >
        Back
      </button>
      ...
      {/* Project Title */}
      <h1 className="text-4xl mb-4 text-customRed">{title}</h1>
      ...
      {/* Tools & Technologies */}
      <div className="mb-6">
        <h2 className="text-2xl mb-2 text-customRed">Tools & Technologies</h2>
      ...
      <div className="flex gap-4">
        <a
          ...
          className="px-4 py-2 bg-customRed text-black rounded hover:bg-white transition-colors"
        >
          GitHub Repo
        </a>
        <a
